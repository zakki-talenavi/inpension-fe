 ...
 *
 * Returns an array of category objects with their counts
 */
...
function isProductCategory(value: string): value is ProductCategory {
  return ['electronics', 'clothing', 'books', 'home', 'sports'].includes(value)
}

export default defineEventHandler((): CategoryResponse[] => {
  ...
  // Convert to array format with validation
  ...
  return categories.toSorted((a, b) => a.category.localeCompare(b.category))
})
